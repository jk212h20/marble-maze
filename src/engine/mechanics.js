...
export const MECHANICS = [
  ...
  },
  {
    ...
    render: 'mesh',
    renderNeedle: 'oneways',
    tuning: [],
    editor: 'oneway',
    status: 'engine-only',
    note: 'Was the one mechanic with a collider and no picture. Now a hinged brass leaf in a routed kerf, leaning the way it is pushed, with an arrow on the floor pointing the way through.',
  },
  {
    key: 'peg',
    label: 'Bumper post',
